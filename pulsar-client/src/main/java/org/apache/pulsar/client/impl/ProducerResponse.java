...
public class ProducerResponse {
    ...
    private Optional<TopicResourceGuardAttestation> resourceGuardAttestation;

    private Optional<Long> connectionGeneration;

    public ProducerResponse(String producerName, long lastSequenceId, byte[] schemaVersion,
                            Optional<Long> topicEpoch) {
        this(producerName, lastSequenceId, schemaVersion, topicEpoch, Optional.empty(), Optional.empty());
    }
